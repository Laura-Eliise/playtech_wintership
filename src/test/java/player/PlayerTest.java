...
class PlayerTest {
    ...
    private final String match_raw_data_2 = "12ae2255-4255-4304-8589-737cdff61634,1.45,0.75,A";
    ...
    private final String player_raw_data_bet_2 = "163f23ed-e9a9-4e54-a5b1-4e1fc86f12f4,BET,12ae2255-4255-4304-8589-737cdff61634,1000,B";
    ...
    public void depositTest() {
        ...
        assertTrue(player.isNotACriminal());
        assertEquals("163f23ed-e9a9-4e54-a5b1-4e1fc86f12f4 4000 0,00", player.toString());
    ...
    public void DepositAndWithdrawTest() {
        ...
        assertTrue(player.isNotACriminal());
        assertEquals("163f23ed-e9a9-4e54-a5b1-4e1fc86f12f4 3700 0,00", player.toString());
    }
    @Test
    public void betTest() {
